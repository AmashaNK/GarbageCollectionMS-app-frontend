...
import { EditNote, Feedback, VisibilityOutlined } from "@mui/icons-material";
    ...
    <div>
      ...
      >
        {[
          ...
          {
            text: "Special Occasion Request",
            icon: <EditNote />,
            link: "/special/occasion-request",
          },
          {
            text: "Add Complaints",
            icon: <Feedback />,
          ...
          >
            <ListItemButton
              ...
              style={{
                backgroundColor:
                  selectedMenuItem === item.text ? "#1C6C6C" : "transparent",
              }}
            >
              <ListItemIcon>
      ...
      >
        <Toolbar>
          ...
          >
            ...
            {selectedMenuItem === "Overview" ? "Overview" : selectedMenuItem}
          </Typography>
